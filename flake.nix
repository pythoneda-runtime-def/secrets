  ...
  inputs = rec {
    ...
    pythoneda-shared-runtime-secrets-events = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-runtime-def/secrets-events/0.0.22";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "secrets";
        version = "0.0.4";
        sha256 = "1aj1bzby73m1ihdz2qfggvw83myj7dm1n8nrgw9gfls1g22nxvfc";
        pname = "${org}-${repo}";
        ...
        pythoneda-runtime-secrets-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-runtime-secrets-events}; do
